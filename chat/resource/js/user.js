  ...
  $(function(){
		if(user['u_id'] != '') {
			...
			var chat_user_list = '<div class="chat-box"><div class="chat-list"><div class="chat-list-top"><h1><i></i>联系人</h1><span class="minimize-chat-list" onclick="chat_show_list();"></span></div>'+
									'<div id="chat_user_list" class="chat-list-content"><div><dl id="chat_user_friends"><dt onclick="chat_show_user_list(\'friends\');"><span class="show"></span>我的好友</dt><dd id="chat_friends"></dd></dl>'+
									'<dl id="chat_user_recent"><dt onclick="chat_show_user_list(\'recent\');"><span class="show"></span>最近联系人</dt><dd id="chat_recent"></dd></dl></div></div>'+
									'</div><div class="bottom-bar"><span id="new_msg" class="ico" onclick="show_dialog();"></span><a href="javascript:void(0)" onclick="chat_show_list();">IM在线联系<i></i></a></div></div>';
	...
	function update_recent(){
		...
		for (var u_id in recent_list){
			if(obj_recent.find("dd[u_id='"+u_id+"']").size()==0) {
				if(user_list[u_id]['online'] > 0 ) {
